...
echo "$($PSQL "select name from teams inner join games on teams.team_id=games.winner_id or team_id=opponent_id where year=2014 AND round='Eighth-Final' order by name")"
